...
<!-- CRISTIAN: I copy pasted the tutorial that we have in spanish -->

<!-- TODO: translate this tutorial to english and adapt the examples. -->

# Tutorial de expresiones regulares y REmatch

## Preliminares

Para instalar la librería REmatch, en cualquier terminal deberían correr el siguiente comando:
